...
cloudinary.config({ 
  cloud_name: 'dxaohiyka', 
  api_key: '776571838696134', 
  api_secret: 'u_gUxzP6L1zSQh9SWrPVylCFP8w' 
});


const onlineDbLink = String("mongodb+srv://blog:blog@blog.hu1nn.mongodb.net/book?retryWrites=true&w=majority") ;
mongoose.connect(onlineDbLink, {
...
app.use(session({
  secret: process.env.STRIPE_SKEY,
  resave: false,
  store: mongoStore,
